...
class Document(BaseModel):
    ...
    def create(cls, name: str, description: str, metadata: Dict = None, file_path: str = None, 
        ...
        # Use fixed format based on the error message
        # The error "Expected 12 columns but got 36" means we need exactly 12 values
        query = f"""
        ...
        params = (
            ...
            1 if indexed else 0,
            filename or ''
            # Removed file_size to match exactly 12 columns
        )
